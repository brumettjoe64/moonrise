...
class GuestsControllerTest < ActionController::TestCase
  ...
  test "should create guest" do
    assert_difference('Guest.count') do
      post :create, guest: { email: @guest.email, firstname: @guest.firstname, lastname: @guest.lastname }
    end
  ...
  test "should update guest" do
    put :update, id: @guest, guest: { email: @guest.email, firstname: @guest.firstname, lastname: @guest.lastname }
    assert_redirected_to guest_path(assigns(:guest))
  end
